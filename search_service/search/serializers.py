...
class ContextSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            "url": {"view_name": "iiif_search.api.context_detail", "lookup_field": "slug"}
        }
...
class IIIFSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {"url": {"view_name": "iiif_search.api.iiifresource_detail"}}
...
class IndexablesSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {"url": {"view_name": "iiif_search.api.indexables_detail"}}
