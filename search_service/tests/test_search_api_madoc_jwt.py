...
def test_iiif_instance(http_service, iiif_collection, madoc_access_jwt_headers):
    """
...
def test_bulk_iiif_ingest(http_service, iiif_collection, madoc_access_jwt_headers):
...
def test_iiif_instance_again(http_service, iiif_collection, madoc_access_jwt_headers):
    """
...
def test_iiif_instance_again_service_token(http_service, iiif_collection, madoc_service_jwt_headers):
    """
    Repost the same single IIIF instance
    """
    foo = iiif_collection
    ...
    headers = {"Content-Type": "application/json", "Accept": "application/json", **madoc_service_jwt_headers}
    result = requests.post(url=http_service + "/api/search/iiif", json=post_json, headers=headers)
    assert result.status_code == 400  # SHould fail but should it be a 400?
...
def test_simple_query_thumbnail(http_service, madoc_access_jwt_headers):
    """
